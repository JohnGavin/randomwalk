# Wait for workflows to complete and merge PR #11 (telemetry vignette)
library(gh)
...
merge_result <- gh::gh(
  ...
  merge_method = "merge",
  commit_title = "Add telemetry vignette with pre-built targets (#10)",
  commit_message = "Merging PR #11 that closes issue #10"
)

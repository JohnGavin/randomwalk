...
ui <- fluidPage(
  ...
  fluidRow(
    column(12,
      # Main Simulation Parameters dropdown (closed by default)
      tags$details(
        open = FALSE,
        tags$summary("Simulation Parameters"),
        fluidRow(
          column(4,
            h5("Grid Settings"),
      ...
      # Movement Settings dropdown (closed by default)
      tags$details(
        open = FALSE,
        tags$summary("Movement Settings"),
        fluidRow(
          column(6,
  ...
  output$status_overlay <- renderUI({
    if (sim_state() == "running") {
      ...
      tags$div(
        ...
        tags$strong("Simulation Running"),
        tags$br(),
        sprintf("Walkers: %d", completed_walkers),
        tags$br(),
        sprintf("Black pixels: %d", black_pixels)
      )
    } else {
      NULL
    }

---
title: "Basic Random Walk Demo"
description: "Minimal interactive demo - try random walks in your browser with basic controls and visualization"
format:
  html:
    code-fold: true
...
server <- function(input, output, session) {
  ...
  output$package_details <- renderText({
    paste0(
      ...
      "=== SYNC MODES (Native R) ===\n\n",
      "sync_mode='static':\n",
      "  - Workers get frozen grid snapshots\n",
      "  - Fastest, lowest collision detection (~5%)\n\n",
      "sync_mode='chunked' (RECOMMENDED):\n",
      "  - Batched updates every 10 walkers\n",
      "  - Best collision detection (~15%)\n",
      "  - Recommended for most use cases\n\n",
      "sync_mode='dynamic' (DEPRECATED):\n",
      "  - nanonext sockets fail in crew subprocesses\n",
      "  - Falls back to static behavior\n",
      "  - DO NOT USE\n\n",
      "sync_mode='mirai_dynamic' (DEPRECATED):\n",
      "  - Same issue as dynamic mode\n",
      "  - Falls back to static behavior\n",
      "  - DO NOT USE"
    )
  })

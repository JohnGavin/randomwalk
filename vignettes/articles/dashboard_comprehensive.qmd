    ...
    column(12,
      tabsetPanel(
        ...
        tabPanel("Walker Paths",
                 ...
                 helpText("Select walkers by termination order. Paths stored for first/last 2000 walkers by ID."),
...
server <- function(input, output, session) {
  ...
  output$stats_quartile_boxplot <- renderPlot({
    ...
    tryCatch({
      print(
        ggplot(df, aes(x = quartile, y = steps, fill = quartile)) +
  ...
  output$stats_quartile_histograms <- renderPlot({
    ...
    tryCatch({
      print(
        ggplot(df, aes(x = steps, fill = quartile)) +

...
- **Walkers**: Number of simultaneous random walkers (1 to 60% of grid,
  default 5)
...
See `vignettes/` for detailed documentation on: - Usage examples -
Performance tuning - Architecture details - Telemetry statistics

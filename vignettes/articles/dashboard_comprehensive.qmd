...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      # Running indicator (spinner shown when simulation active)
      div(id = "running_indicator", style = "text-align: center; margin: 10px 0;",
        conditionalPanel(
          condition = "output.is_running",
          tags$div(class = "spinner", style = "margin: 0 auto;"),
          tags$p("Simulation running...", style = "font-weight: bold; color: #007bff;")
        )
      ),

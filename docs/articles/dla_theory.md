...
The fractal dimension remains $`D_f \approx 1.71`$ across different
lattices - Growth patterns show self-similarity across scales -
...
Techniques for analysis include: - Averaging over multiple
realizations - Measuring ensemble properties (fractal dimension, density
profiles) - Using larger clusters to reduce finite-size effects

    ...
    column(12,
      tabsetPanel(
        ...
        tabPanel("Fractal Graph",
                 ...
                 # Progress display ABOVE the plot
                 conditionalPanel(
                   condition = "output.is_running",
                   wellPanel(
                     style = "background-color: #fff3cd; border: 2px solid #ffc107; padding: 10px;",
                     h4("Simulation Running...", style = "color: #856404; margin: 0;"),
...
server <- function(input, output, session) {
  ...
  output$progress_text <- renderText({
    if (sim_state() == "running") {
      ...
      sprintf("Walkers: %d/%d | Black pixels: %d | Time: %s",
